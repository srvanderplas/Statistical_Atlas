...
As a measure of the error we use the log ratio between the estimated and the actual size of the piece. A positive log ratio means that the participant  overestimated the size of the piece in his or her estimate. Similarly, a negative log ratio corresponds to a visual underestimation of the piece.
