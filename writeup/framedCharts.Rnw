...
\paragraph{Participants} Participants were recruited using reddit and Amazon Mechanical Turk. Participants were required to be over 18, and we collected information about their age, gender, and education levels. \svp{Add in more information about demographics.}
% Add demographic information, explain difference between reddit and turk populations
\hh{First atempt at demographics in \autoref{fig:demographics}.}
