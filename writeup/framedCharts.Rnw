...
<<participant-variability, include = F,  eval=T, echo=FALSE, fig.width = 5, fig.height = 3,  fig.cap = "Variability is lower in responses from participants recruited from reddit compared with participants recruited from Amazon Turk.">>=
...
<<participant-preference, include = F, eval=T, echo=FALSE, fig.width = 5, fig.height = 4,  fig.cap = "Histograms show preference for rounding to 5.">>=
percentages$source <- factor(percentages$source,
