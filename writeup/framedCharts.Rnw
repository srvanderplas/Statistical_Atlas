...
While aesthetically appealing, framed charts are an inferior choice if the goal is to effectively communicate information. The Census Bureau did an incredible job at collecting, tabulating, visualizing, and maintaining the data presented in the Statistical Atlas. Reproducibility has risen to a highly discussed topic in science lately, but few researchers even attempt to preserve their data and methods in such a way that the results could be precisely duplicated 150 years later. The Census Bureau (in conjunction with the Library of Congress) has managed to make it fairly easy for researchers to access the data necessary to conduct this study online.

In addition to the technical feat of reproducibility, the Statistical Atlas, spearheaded by the vision of Francis Walker, represented a state-sponsored foray into the development and use of new types of charts. While framed plots are aesthetically appealing, they are not effective at communicating numerical information accurately. With 107 pages of charts, and several relatively new types of plots, it is not surprising that some of these experiments fell flat. In addition, due to the limitations of printing technology at the time, some of the design choices are pragmatic, as well as aesthetic.

The real conclusion from this study is that of all of the successes which underlie the creation of the 1870 Statistical Atlas, it would be better to leave the framed charts in the annals of history and focus on the remarkably resilient infrastructure which allows us to test this hypothesis 150 years later.
