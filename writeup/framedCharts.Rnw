...
\includegraphics[height=.4\textwidth]{figure/overall-work-mosaic-unaccommodated-1}
\label{fig:redo-1}
  }
  \hfill
  \subfloat[US-wide overview with integrated number of not-gainfully employed population.]{
\includegraphics[height=.4\textwidth]{figure/overall-work-mosaic-unaccommodated-2}
  \label{fig:redo-2}
  }
  \hfill
