...
<<demo0, echo=FALSE, fig.height=3.5, fig.width=5, include=F>>=
...
@
<<demo1, echo=FALSE, fig.height=3.5, fig.width=5, include=F>>=
...
<<demo2, echo=FALSE, fig.height=4, fig.width=5, include =F>>=
...
levels(edu_summ$Education)[4:5] <- c("Bachelor degree", "Graduate degree")

edu_summ$source <- factor(edu_summ$source)
edu_summ$source <- factor(edu_summ$source, levels=c("reddit", "amazon", "US population"))
...
<<demo3, echo=FALSE, fig.height=4, fig.width=5, include=F>>=
...
age_summ$source <- factor(age_summ$source, levels=c("reddit", "amazon", "US population"))
