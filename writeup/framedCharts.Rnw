...
<<demo0, echo=FALSE, fig.height=4, fig.width=5, include=F>>=
...
levels(edu_summ$Education)[4:5] <- c("Bachelor degree", "Master degree or higher")
...
<<demo3, echo=FALSE, fig.height=3.5, fig.width=5, include=F>>=
