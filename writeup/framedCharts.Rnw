...
datapath <- "../data"
load(file.path(datapath, "Statistical_Atlas_Data.Rdata"))
load(file.path(datapath, "Auxiliary_Data.Rdata"))

# percentages <- readr::read_csv(file.path(datapath, "study-results.csv"))
demographics <- read.csv(file.path(datapath, "demographics.csv"),
                        stringsAsFactors = FALSE)
percentages <- readr::read_csv(file.path(datapath, "Cleaned_Data.csv"))
@
