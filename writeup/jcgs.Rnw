...
\svp{Reference:\begin{itemize}\item Power model for proportion/area judgments\cite{hollands1997bias}\item Simple graphical elements psychophysics \cite{spence1990visual}\item Cleveland and McGill\end{itemize}}
